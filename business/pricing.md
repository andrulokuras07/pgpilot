...
- **Riesgo: validación de pricing.** Estos precios no han sido probados con paying customers todavía (la prueba real es post-Demo Day). Señales de las 3 entrevistas: Raúl (F8, desarrollador fullstack) cuestionó el modelo por BD con 15-20 BDs — sugirió explorar pricing por usuarios o por tiempo de ejecución; Carlos (F6) y Jos (F7) no objetaron el rango $50-200/BD aunque no se les preguntó precio per-dev exacto. **Decisión:** mantener Pro $29 y Team $49. El plan B "$19" queda como contingencia para casos sin autonomía de compra del dev. Considerar modelo alternativo para cuentas con muchas BDs.
