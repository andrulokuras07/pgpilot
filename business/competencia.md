...
- Ninguno de los competidores tiene mercado LATAM validado todavía, pero tampoco PgPilot — la hipótesis del foco regional necesita validarse en las entrevistas de F6-F8.
...
> **Nota de mantenimiento:** este archivo y `business/competencia.docx` se generan desde el mismo cuerpo de investigación. El `.docx` se produce con `scripts/generate_competencia_docx.py`. Si actualizas la investigación, actualiza ambos archivos en el mismo commit para que no diverjan.
